...
Sculpture::Sculpture(const std::string &filename, const std::string &tag, const std::string &filename2, const std::string &tag2)
{
    ...
    Load_Todays_On_Off_Time("swirl_files/DM_On_Off_Times_No_DST.txt", On_Off_Time_Struct);
    ...
    std::cout
        ...
        << std::setw(2) << std::setfill('0')
        << Current_Time_Struct.current_minutes_with_dst << '\n'
...
int Sculpture::Minutes_Since_6AM(int hour, int minute)
{
...
int Sculpture::Get_Day_Of_Year_No_Leap()
{
...
bool Sculpture::Parse_Day_Of_Year(const std::string &date_string, int &day_of_year)
{
...
bool Sculpture::Load_Todays_On_Off_Time(const std::string &filename, OnOffTime_Info &today)
{
...
Sculpture::CurrentTimeInfo Sculpture::Get_Current_Time_Info()
{
