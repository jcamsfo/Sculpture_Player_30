...
struct ProcessParams
{
  ...
  int Pause_Toggle = Process_Default_Limits[PAUSE_TOGGLE].Default;
  int Fast_Forward = Process_Default_Limits[FAST_FORWARD].Default;
  int Rewind = Process_Default_Limits[REWIND].Default;
  int Quit = Process_Default_Limits[QUIT].Default;
};
